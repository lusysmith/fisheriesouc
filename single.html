...
<html>
<head>
<title>Duplex a Magazine Category Flat Bootstarp responsive Website Template| Single :: w3layouts</title>
						...
						<div class="banner-grids">
							<div class="banner-top">
								...
								<ul class="nav banner-nav">                                       
										...
										<li class="dropdown1"><a href="culture.html">Culture</a>
											<ul class="dropdown2">
										...
										<li class="dropdown1"><a href="lifestyle.html">Lifestyle</a>
											<ul class="dropdown2">
												<li><a href="lifestyle.html">Lifestyle</a></li>
												<li><a href="archives.html">Archives</a></li>
												<li><a href="fullwidth.html">Fullwidth</a></li>
										...
										<li class="dropdown1"><a href="archives.html">Archives</a>
											<ul class="dropdown2">
												<li><a href="lifestyle.html">Lifestyle</a></li>
												<li><a href="archives.html">Archives</a></li>
												<li><a href="fullwidth.html">Fullwidth</a></li>
							...
							<div class="banner-middle">
								...
								<div class="banner-bottom-grids">
									...
									<div class="col-md-8 banner-bottom-left">
										<div class="banner-bottom-left-grids">
											<div class="single-left-grid">
												<h4>Fly Fishers Serving as Transports for Little Invaders</h4>
												<p class="comments">Written by Orman Clark  //  August 4 2010  //  Category One, Category Two  // <a href="#">8 Comments</a></p>
												<img src="images/pp5.jpg" class="img-responsive" alt="" />
												<p class="text">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. Nullam id dolor id nibh ultricies vehicula ut id elit. Duis mollis, est non commodo luctus, nisi erat porttitor ligula, eget lacinia odio sem nec elit. Sed posuere consectetur est at lobortis. Curabitur blandit tempus porttitor. Cras mattis </p>
												<p class="text-1">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. </p>
												<p class="text-2">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit amet risus. Nulla vitae elit libero, a pharetra augue. Sed posuere consectetur est at lobortis. </p>
												<div class="clearfix"> </div>
												<p class="text-3">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit </p>
												<p class="text-3">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit </p>
												<p class="text-4">Fusce dapibus, tellus ac cursus commodo, tortor mauris condimentum nibh, ut fermentum massa justo sit </p>
												<div class="clearfix"> </div>
											</div>
										</div>
										<!-- post -->
										<div class="post">
											...
											<div class="post-grids">
												<div class="col-md-4 post-left">
													<a href="single.html"><img src="images/pic1.jpg" alt="" /></a>
												</div>
									...
									<div class="col-md-4 banner-bottom-right">
										...
										<div class="lor-ip">
											<div class="lor-ip">
												<div class="fb-like-box" data-href="https://www.facebook.com/w3layouts" data-width="240" data-height="270" data-colorscheme="light" data-show-faces="true" data-header="true" data-stream="false" data-show-border="true"></div>
													<div id="fb-root"></div>
			...
			<div class="footer-grids">
				...
				<div class="col-md-4 viewport">
					...
					<p>Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
						...
						<span>Many desktop publishing packages and web page editors now use Lorem Ipsum as their default model text, and a search for 'lorem ipsum' will uncover many web sites still in their infancy. Various versions will uncover many web sites still in their infancy have evolved</span> 
						There are many variations of passages of Lorem Ipsum available, but the majority have suffered alteration in some form model text, and.
					</p>
				</div>
				<div class="col-md-4 recent-posts footer-left">
					<h3>Latest Posts</h3>
					<ul>
						<li><a href="#">Skype 5.0 Beta for Mac Arrives… But Where’s Facebook?</a></li>
						...
						<li><a href="#">Displaying Shooting Touch, Knicks Return to Prime Time</a></li>
					</ul>
				</div>
				...
				<div class="col-md-4 footer-flick">
					...
					<div class="clearfix"> </div>
				<div class="copyright">
					<p>Copyrights © 2015 Duplex All rights reserved | Template by <a href="http://w3layouts.com/"> W3layouts</a></p>
				</div>
			</div>
	</div>
	</div>
